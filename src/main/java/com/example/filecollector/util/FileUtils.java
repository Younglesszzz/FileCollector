...
public class FileUtils {
     ...
     * @return 数据库中的file
     */
    public static com.example.filecollector.po.File convertFile(MultipartFile uploadFile) {
        com.example.filecollector.po.File newFile = new com.example.filecollector.po.File(uploadFile.getOriginalFilename());
